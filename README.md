...
|-------|----------|-------|--------------|
| State (government + ministerial) | Riigi tasandi maarused | ~3,820 | `estleg:NationalRegulation` |
| Municipal (KOV) | KOV maarused | ~11,087 (opt-in) | `estleg:MunicipalRegulation` |
...
```
.
├── krr_outputs/              # JSON-LD ontology files (5,200+ files)
