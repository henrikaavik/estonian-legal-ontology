...
**Status: 1,122 enacted laws (1,195 law files) + 22,832 drafts + 3,812 state regulations + 11,059 municipal regulations (opt-in) + 12,104 court decisions + 33,242 EU acts + 22,290 EU court decisions** | **27,228 JSON/JSON-LD files** | **170,000+ semantic nodes**
...
```
.
├── krr_outputs/              # JSON/JSON-LD ontology files (27,228 files)
