...
from estleg.generate_kars_eriosa_jsonld import (  # sibling script, resolved via sys.path
    _join_label,
    child_text,
    ln,
    sanitize_identifier,
...
OUT_DEFAULT = (
    Path(__file__).resolve().parents[2] / "krr_outputs" / "tsus_osa7_138_169_owl.jsonld"
)
