...
|---|---|---|
| **live-DAG** | `run_all_integration.py` steps | `extract_cross_references.py`, `classify_eurovoc.py`, `fix_all_issues.py` |
...
| **manual-ops** | Fitness / coverage | `eval_harness.py`, `kov_pipeline_coverage.py`, `verify_layer1.py` |
